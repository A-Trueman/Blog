...
<div class="blog-masthead">
    <div class="container">
        <nav class="blog-nav">
            ...
            <a class="blog-nav-item active" href="/attention.html">关注</a>
            ...
            <ul class="pagination">
                <c:if test="${not empty lessDateTime || not empty lastDateTime}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="/attention.html?lessDateTime=${lessDateTime}&pageCount=${pageCount}">前一页</a></li>
                        </c:otherwise>
                    </c:choose>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="/attention.html?lastDateTime=${lastDateTime}&pageCount=${pageCount}">后一页</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:if>
            </ul>
